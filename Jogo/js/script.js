...
function declareWinner(winner) {
    ...
    let scoreBordO = document.querySelector('#scoreboard-2')
    let msg = '';
    ...
    if (winner == 'x') {
        ...
        scoreBordO.textContent = parseInt(scoreBordO.textContent) + 1;
...
function computerPlay() {
    ...
    for (let i = 0; i < boxes.length; i++) {
        ...
        if (boxes[i].childNodes[0] == undefined) {
            ...
            //Contador para verificar quantas estão preenchidas
        } else {
            filled++;
        }
